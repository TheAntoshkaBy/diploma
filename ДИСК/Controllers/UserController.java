...
public class UserController implements BookingClubController<UserDto> {
    ...
    public ResponseEntity<UserList> findAll(
        ...
        List<UserDto> searchedUsers = converter.convert(service.findAllUsers(page, size));
    ...
    public ResponseEntity<EntityModel<UserDto>> create(@Valid @RequestBody UserDto userDTO) {
        ...
        public ResponseEntity<EntityModel<bookOrderDTO>> addOrder(
                                                    @PathVariable long id, HttpServletRequest request,
                                                    @RequestBody bookOrderDTO orderDTO) {
            ControllerUtils.checkUserRulesById(request, id);
      ...
      public ResponseEntity<OrderList> findOrders(@PathVariable long id,
          ...
          ControllerUtils.checkUserRulesById(request, id);
          List<bookOrderPOJO> ordersByUser = orderService.findAllByOwner(id, page, size);
      ...
      public ResponseEntity<EntityModel<bookOrderDTO>> addbooks(
          ...
          bookOrderDTO bookOrderDTO =
              new bookOrderDTO(orderService.addbooks(id, booksId
                                                                            .getAddedbooks()));
          return new ResponseEntity<>(bookOrderDTO.getModel(), HttpStatus.OK);
      }
